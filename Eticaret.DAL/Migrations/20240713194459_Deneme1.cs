    ...
    public partial class Deneme1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sayfalars", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EtiketsId = table.Column<int>(type: "int", nullable: false),
                    MakalesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EtiketMakale", x => new { x.EtiketsId, x.MakalesId });
                    table.ForeignKey(
                        name: "FK_EtiketMakale_Etikets_EtiketsId",
                        column: x => x.EtiketsId,
                        principalTable: "Etikets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EtiketMakale_Makales_MakalesId",
                        column: x => x.MakalesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EtiketMakale_MakalesId",
                table: "EtiketMakale",
                column: "MakalesId");
